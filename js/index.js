NProgress.start();
$(function() { $("#myTabContent").swiperight(function() { var $tab = $('#tablist .active').prev(); if ($tab.length > 0) $tab.find('a').tab('show'); }); $("#myTabContent").swipeleft(function() { var $tab = $('#tablist .active').next(); if ($tab.length > 0) $tab.find('a').tab('show'); }); $("#myTabContent2").swiperight(function() { var $tab = $('#tablist1 .active').prev(); if ($tab.length > 0){ $tab.find('a').tab('show'); } }); $("#myTabContent2").swipeleft(function() { var $tab = $('#tablist1 .active').next(); if ($tab.length > 0){ $tab.find('a').tab('show'); } }); $("#myTabContent3").swiperight(function() { var $tab = $('#tablist2 .active').prev(); if ($tab.length > 0){ $tab.find('a').tab('show'); } }); $("#myTabContent3").swipeleft(function() { var $tab = $('#tablist2 .active').next(); if ($tab.length > 0){ $tab.find('a').tab('show'); } }); });
      ...
      $(document).ready(function() {
        ...
        $('#reportrange').on('apply.daterangepicker', function(ev, picker) {
            ...
            if(startDate==endDate){
                ...
                for (var i = 0; i < chartdata.length; i++) {
                    tst += +chartdata[i].khoanthu;
                    tsc += +chartdata[i].khoanchi;
                    data.addRows([[chartdata[i].gio+"h",+chartdata[i].khoanthu, +chartdata[i].khoanchi]]);
                }
                $('#tst').html(changemoneyshow(tst)+' vnđ');
                $('#tsc').html(changemoneyshow(tsc)+' vnđ');       
      ...
      $(document).ready(function() {
        ...
        $('#divthemchitieu').hide();
        $('#themchitieu').hide();
        $('#clickthemchitieu').hide();
        $('#bthemchitieunhanh').on('click',function(){
          $('#divthemchitieu').show();
          $('#tenchitieu').focus();
          $('#bchonchitieu').show();
          $('#goback').hide();
          $('#divchonchitieu').hide();
          $('#bthemchitieunhanh').hide();
          $('#clickthemchitieu').show();
          $('#h2themchitieu').html('Thêm chi tiêu');
          $('#tenchitieu').val('');
          $('#mota10').val('');
          $('#sotien10').val('');
          $('input[name=themchitieu]').attr('checked',false);
          $('input:radio[name="taikhoan2"]').filter('[value="Tiền mặt"]').prop('checked', true);
        });
        $('#bchonchitieu').on('click',function(){
          $('#divthemchitieu').hide();
          $('#bchonchitieu').hide();
          $('#divchonchitieu').show();
          $('#goback').show();
          $('#bthemchitieunhanh').show();
          $('#h2themchitieu').html('Chọn chi tiêu');
          $('#clickthemchitieu').hide();
          $('#clickupdatechitieu').hide();
        });
        ...
        $("#quayvechontienmat").on("click",function(){
          ...
          $('input:radio[name="taikhoan1"]').filter('[value="Tiền mặt"]').prop('checked', true);
          $('#tk3').trigger("click");
          $('input[name=taikhoan2').attr('checked',false);
          $('input:radio[name="taikhoan2"]').filter('[value="Tiền mặt"]').prop('checked', true);
          $('#tk5').trigger("click");
        });
      ...
      var refdutienmat=firebase.database().ref('users/'+localStorage.getItem('key')+'/tien/lichsutienmat');
                      ...
                      if(i<10){
                        if(array[i].trangthai=="Chi"){
                              if(array[i].trangthai1 !=null){
                                $('#lichsutienmat').append('<tr><td>'+ array[i].ngaythang +'</td><td>'+ array[i].trangthai1 +'</td><td><b style="color:#F52727" class="fa fa-long-arrow-down"> '+ changemoneyshow(array[i].sotien)+'</b> vnđ</td><td>'+ changemoneyshow(array[i].sodu)+' vnđ</td></tr>');
                              }else
                                $('#lichsutienmat').append('<tr><td>'+ array[i].ngaythang +'</td><td>'+ array[i].trangthai +'</td><td><b style="color:#F52727" class="fa fa-long-arrow-down"> '+ changemoneyshow(array[i].sotien)+'</b> vnđ</td><td>'+ changemoneyshow(array[i].sodu)+' vnđ</td></tr>');
                        }else{
                            if(array[i].trangthai1 !=null){
                                $('#lichsutienmat').append('<tr><td>'+ array[i].ngaythang +'</td><td>'+ array[i].trangthai1 +'</td><td><b style="color:#27C416" class="fa fa-long-arrow-up"> '+ changemoneyshow(array[i].sotien)+'</b> vnđ</td><td>'+ changemoneyshow(array[i].sodu)+' vnđ</td></tr>');
                            }else
                                $('#lichsutienmat').append('<tr><td>'+ array[i].ngaythang +'</td><td>'+ array[i].trangthai +'</td><td><b style="color:#27C416" class="fa fa-long-arrow-up"> '+ changemoneyshow(array[i].sotien)+'</b> vnđ</td><td>'+ changemoneyshow(array[i].sodu)+' vnđ</td></tr>');
                        }  
                      }else{
      ...
      $(document).on("click", ".opendata7ngay", function () {
        ...
        refdanhsachthe.on('value', function(snapshot) {
          ...
          var reflichsucard1=firebase.database().ref('users/'+localStorage.getItem('key')+'/tien/lichsucard');
      ...
      $(document).on("click", "#themsotietkiem", function () {
        ...
        $(document).on("click", "#clickthemchitieu", function () {
            var sotien=$('#sotien10').val();
            if(sotien.length==5){
              sotien=sotien.substr(0,1)+sotien.substr(2,5);
            }else if(sotien.length==6){
              sotien=sotien.substr(0,2)+sotien.substr(3,6);
            ...
            if($('#tenchitieu').val()==""){
                $('.err10').html('<ul><li style="color:red;font-size:16px">Vui lòng nhập tên chi tiêu</li</ul>');
                return false;
            }else if ($('input[name=themchitieu]:checked').val() == null || $('input[name=themchitieu]:checked').val() =="") {
                $('.err10').html('<ul><li style="color:red;font-size:16px">Vui lòng chọn loại chi tiêu</li</ul>');
                return false;
            }else if($('#sotien10').val()==""){
                $('.err10').html('<ul><li style="color:red;font-size:16px">Vui lòng nhập số tiền</li</ul>');
                return false;
            }else if($('#sotien10').val().charAt(0)=="0"){
                $('.err10').html('<ul><li style="color:red;font-size:16px">Số tiền không hợp lệ</li</ul>');
                return false;
            }else  if($('#mota10').val()==""){
                $('.err10').html('<ul><li style="color:red;font-size:16px">Vui lòng nhập mô tả</li</ul>');
                return false;
            }else{
                if($('input[name=taikhoan2]:checked').val()=="Card"){
                  for (var i = 0; i < sothe.length; i++) {
                    if(sothe[i].sothe==$('input[name=chonthe]:checked').val()){
                        firebase.database().ref('users/'+localStorage.getItem('key')+'/tien/themchitieunhanh').push().set({
                              tenchitieu:$('#tenchitieu').val(),
                              sotien:sotien,
                              mota:$('#mota10').val(),
                              loaichitieu:$('input[name=themchitieu]:checked').val(),
                              taikhoan:'Thẻ',
                              sothe:sothe[i].sothe
                        });
                    }
      ...
      var themchitieu=[];
      firebase.database().ref('users/'+localStorage.getItem('key')+'/tien/themchitieunhanh').on('value', function(snapshot) {
                themchitieu=[];
                $('#themchitieunhanh').html('');
                snapshot.forEach(function(childSnapshot) {
                  themchitieu.push({tenchitieu:childSnapshot.val().tenchitieu,loaichitieu:childSnapshot.val().loaichitieu,sotien:childSnapshot.val().sotien,mota:childSnapshot.val().mota,sothe:childSnapshot.val().sothe,taikhoan:childSnapshot.val().taikhoan,key:childSnapshot.key});
                  $('#themchitieunhanh').append('<tr><td width="70%"><b>'+ childSnapshot.val().tenchitieu +'</b><br> Số tiền: '+changemoneyshow(childSnapshot.val().sotien)+' vnđ</td><td><div class="row" style="padding-left:7px"><button type="button" class="btn btn-success col-md-4 col-xs-11 addchitieu" style="float:left" data-key="'+childSnapshot.key+'">Chọn</button> <button type="button" class="btn btn-primary col-md-4 col-xs-11 updatechitieu" data-key="'+childSnapshot.key+'">Cập nhật</button><button type="button" class="btn btn-danger col-md-3 col-xs-11 deletechitieu" data-key="'+childSnapshot.key+'">Xoá</button></td></div></tr>');
                });
      });
      var keychitieu;
      $(document).on("click", ".addchitieu", function () {
          keychitieu= $(this).data('key');
          for (var i = 0; i < themchitieu.length; i++) {
            if(themchitieu[i].key==keychitieu){
              $('#sotien').val(changemoneyshow(themchitieu[i].sotien));
              $('#mota').val(themchitieu[i].mota);
              $('input:radio[name="chitieu"]').filter('[value="'+themchitieu[i].loaichitieu+'"]').prop('checked', true);
              if(themchitieu[i].taikhoan=="Thẻ"){
                  $('input:radio[name="taikhoan"]').filter('[value="Card"]').prop('checked', true);
                  $('input:radio[name="chonthe"]').filter('[value="'+themchitieu[i].sothe+'"]').prop('checked', true);
              }else{
                  $('input:radio[name="taikhoan"]').filter('[value="Tiền mặt"]').prop('checked', true);
              }
              myclick();
      ...
      $(document).on("click", ".deletechitieu", function () {
          keychitieu= $(this).data('key');
          $('#myModal12').modal('show');  
      });
      $(document).on("click", "#xoathemchitieu", function () {
          firebase.database().ref('users/'+localStorage.getItem('key')+'/tien/themchitieunhanh/' + keychitieu).remove();
      });
      $(document).on("click", ".updatechitieu", function () {
          $('#divthemchitieu').show();
          $('#tenchitieu').focus();
          $('#bchonchitieu').show();
          $('#h2themchitieu').html('Cập nhật chi tiêu');
          $('#goback').hide();
          $('#divchonchitieu').hide();
          $('#bthemchitieunhanh').hide();
          $('#clickupdatechitieu').show();
          keychitieu= $(this).data('key');
          for (var i = 0; i < themchitieu.length; i++) {
            if(themchitieu[i].key==keychitieu){
              $('#tenchitieu').val(themchitieu[i].tenchitieu);
              $('#mota10').val(themchitieu[i].mota);
              $('#sotien10').val(changemoneyshow(themchitieu[i].sotien));
              $('input:radio[name="themchitieu"]').filter('[value="'+themchitieu[i].loaichitieu+'"]').prop('checked', true);
              if(themchitieu[i].loaichitieu=="Đi chơi"){
                  $('#dichoi3').trigger("click");
               }else  if(themchitieu[i].loaichitieu=="Đổ xăng"){
                  $('#doxang3').trigger("click");
               } if(themchitieu[i].loaichitieu=="Mua đồ"){
                  $('#muado3').trigger("click");
               }else{
                 $('#' + themchitieu[i].loaichitieu +"3" ).trigger("click");
               }
              if(themchitieu[i].taikhoan=="Thẻ"){
                  $('input:radio[name="taikhoan2"]').filter('[value="Card"]').prop('checked', true);
                  $('input:radio[name="chonthe"]').filter('[value="'+themchitieu[i].sothe+'"]').prop('checked', true);
                  $('#tk5').attr('class','btn btn-primary fa fa-usd');
                  $('#tk6').attr('class','btn btn-danger fa fa-credit-card active');
              }else{
                  $('input:radio[name="taikhoan2"]').filter('[value="Tiền mặt"]').prop('checked', true);
                  $('#tk5').trigger("click");
              }
      ...
      $(document).on("click", "#clickupdatechitieu", function () {
            var sotien=$('#sotien10').val();
            if(sotien.length==5){
              sotien=sotien.substr(0,1)+sotien.substr(2,5);
            }else if(sotien.length==6){
                ...
                if($('input[name=taikhoan2]:checked').val()=="Card"){
                  for (var i = 0; i < sothe.length; i++) {
                    if(sothe[i].sothe==$('input[name=chonthe]:checked').val()){
                        ...
                        var updates = {};
                        updates['/users/'+localStorage.getItem('key')+'/tien/themchitieunhanh/' + keychitieu] = postData;
